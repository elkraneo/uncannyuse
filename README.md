...
Currently covers **62 public RealityKit `Component` types** from Xcode 26.4 with:
...
All data is extracted from `RealityFoundation.swiftinterface` files in the Xcode 26.4 SDK and from binary string analysis of `RealityToolsFoundation.framework`. macOS versions are inferred from SDK era — verify against Apple documentation.
